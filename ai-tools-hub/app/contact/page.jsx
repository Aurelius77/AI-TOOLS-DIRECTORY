...
export default function Contact(){
  ...
  <h1 className="text-3xl font-bold text-center mb-6 text-gray-600">Contact Us</h1>
  <p className="text-center text-gray-600 mb-8">You can reach out to us by sending your message below</p>
  ...
  <form onSubmit={handleSubmit}>
    ...
    <div className="mb-8">
      <label className="block text-gray-700 font-semibold mb-2">Contact(optional)</label>
      <input type="text"
       ...
       name = 'contact'
       />
      <p className="text-xs text-gray-500 mt-2">You can add your contact for us to reach out more easily.</p>
    </div>
  ...
  <h1 className="text-center">You can also reach us at</h1>
  <div className="flex items-center justify-between">
     <Link href='https://x.com/aureliustheIV'><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
...
<Link href='https://github.com/Aurelius77'>
...
<Link href='https://www.linkedin.com/in/samson-akinpelu-abb585258/'>
<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
...
<Link href='https://wa.me/+2348147364017'>
<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
